        ...
        <div>
            <div className="container mb-5">
                <div className="row justify-content-center">
                    ...
                    <Card mode={props.mode} title="Feeling Bored" icon="bi bi-emoji-dizzy" desc="Feeling bored - this will give you daily life environment effective activities to kill your boredom." link="/tools/feeling-bored" imgli="https://assets.entrepreneur.com/content/3x2/2000/1651673015-shutterstock-2098527055.jpg?crop=16:9" />
                </div>
            </div>
        </div>
    )
